...
///////////////////////////////////////////////////////////////////////////
  getFlatRobots() {
    const flat = {};
    for (const key in this.robots) {
      Object.assign(flat, this.robots[key]);
    }
    return flat;
  }
  ...
  clientConnect(key, socket) {
    ...
    this.clientMessenger.sendTo(key, 'robots', this.getFlatRobots()); ////////////////////////////////////////////////////////////////////////////////
  }
  ...
  gripperSetPos(key, robotId, pos, speed, force, wait) {
    ...
    if (this.robots[key] && this.robots[key][robotId]) {          ////////////////////////////////////////////////////
